...
Now that we've found our **API Key**, we are ready to launch our Rackspace host(s). Under the **Infrastucture -> Hosts** tab, click **Add Host**. Select the **Rackspace** icon. 
