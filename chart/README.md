...
| `tls.enabled`                  | false                                                 | ***bool***   - Enable/Disable tls on rancher itself from secret
                                                                                                          |
| `tls.offload`                  | "ingress"                                             | ***string*** - See External TLS Termination for details. - *"ingress, external"*                                                                                                                             |
| `tlsSecrets.ca`                | "tls-ca-volume"                                       | ***string*** - privateCa tls secret location                                                                                                                                                                 |
| `tlsSecrets.caAdditional`      | "tls-ca-additional-volume"                            | ***string*** - additionalTrustedCAs tls secret location                                                                                                                                                      |
| `tlsSecrets.certificate`       | "tls-rancher-certificate-volume"                      | ***string*** - tls.enabled secret location                                                                                                                                                                   |
| `tlsSecrets.certificateIngress`| "tls-rancher-ingress"                                 | ***string*** - tls.offload "ingress" secret location                                                                                                                                                         |
| `tlsSecrets.autogen`           | "tls-rancher"                                         | ***string*** - ingress.tls.source "rancher" secret location                                                                                                                                                  |
