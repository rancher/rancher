...
| `nodeSelector`                 | {}                                           | ***map*** - Specifies node labels Rancher pods should be deployed to                                                                                                                                    |
| `tolerations`                 | []                                           | ***list*** - Rancher pods tolerations                                                                                                                                   |
| `nodeAffinity`                 | {}                                           | ***map*** - NodeAffinity rule for Rancher pods                                                                                                                                |
