...
| `podSecurityContext`                     | {}                                                                        | ***object*** - Set a pod securityContext (see `values.yaml` documentation for examples) |
| `securityContext`                        | {}                                                                        | ***object*** - Set a container securityContext (see `values.yaml` documentation for example) |
