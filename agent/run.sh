...
inspect_host()
{
    docker run --rm --privileged -v /var/lib:/var/lib ${CATTLE_AGENT_IMAGE} inspect-host
}
...
resolve_image()
{
    ...
    info Agent image to run: ${CATTLE_AGENT_IMAGE}
    info Running image: ${RANCHER_AGENT_IMAGE}
}
