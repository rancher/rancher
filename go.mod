...
replace (
	github.com/rancher/aks-operator => github.com/krunalhinguu/aks-operator v1.31.0-rancher2
	github.com/rancher/apiserver => github.com/krunalhinguu/apiserver v1.31.0-rancher1
...
require (
	...
	github.com/rancher/aks-operator v1.9.1
	...
	github.com/rancher/eks-operator v1.9.1
	github.com/rancher/fleet/pkg/apis v0.10.0
	github.com/rancher/gke-operator v1.9.1
