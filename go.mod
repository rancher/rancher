...
// apiserver hotfix: https://github.com/rancher/apiserver/compare/v0.6.3...aruiz14:apiserver:hotfix-v2.12.2-hotfix-84f0?expand=0
replace github.com/rancher/apiserver => github.com/aruiz14/apiserver v0.0.0-20251023150147-ad18a2ce05e2
...
require (
	...
	github.com/rancher/steve v0.6.40
