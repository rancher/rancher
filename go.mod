...
require (
	...
	github.com/rancher/rke v1.8.10-rc.2
	github.com/rancher/shepherd v0.0.0-20251216155508-9377ed7ce1ea
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudformation v1.68.3 // indirect
