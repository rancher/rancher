...
require (
	...
	github.com/rancher/rke v1.1.0-rc9.0.20200308184752-4a0941bc8a7a
	github.com/rancher/security-scan v0.1.7-0.20200222041501-f7377f127168
	github.com/rancher/steve v0.0.0-20200310061740-02caeafb5d9e
	github.com/rancher/system-upgrade-controller v0.3.1
	github.com/rancher/types v0.0.0-20200309191355-ad773344a3b6
