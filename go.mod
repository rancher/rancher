...
replace (
	...
	k8s.io/client-go => github.com/rancher/client-go v1.28.6-rancher1.0.20240808123133-b7cb2d9207c6
...
require (
	...
	github.com/rancher/aks-operator v1.2.3
	...
	github.com/rancher/eks-operator v1.3.3
