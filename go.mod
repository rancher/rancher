...
require (
	...
	github.com/rancher/aks-operator v1.11.2-rc.1
	github.com/rancher/apiserver v0.5.2
	github.com/rancher/channelserver v0.7.0
	github.com/rancher/dynamiclistener v0.6.2
	github.com/rancher/eks-operator v1.11.2-rc.1
	github.com/rancher/fleet/pkg/apis v0.12.3-beta.1
	github.com/rancher/gke-operator v1.11.2-rc.1
	...
	github.com/rancher/rke v1.8.3-rc.1
