...
replace (
	...
	github.com/rancher/rke => github.com/rawmind0/rke v0.1.6-rc3.0.20210118144808-0472fae650ae
	github.com/rancher/types => github.com/rawmind0/types v0.0.0-20210118143454-bb3b606b1c64
