...
replace (
	github.com/rancher/machine => github.com/chiukapoor/machine v0.15.0-rancher99.0.20240131190156-595a86cb3b76
	github.com/rancher/rke => github.com/chiukapoor/rke v1.5.0-rc5.0.20240213203043-d6798a8c1c74
)
