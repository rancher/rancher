...
replace (
	...
	github.com/rancher/norman => github.com/rmweir/norman v0.0.0-20191023213049-1e281c60a07c
...
require (
	...
	github.com/rancher/rke v0.3.0
	github.com/rancher/types v0.0.0-20191022180246-16517af8b7d6
