...
replace (
	...
	github.com/rancher/norman => github.com/StrongMonkey/norman v0.0.0-20200814232351-061592eed263
	github.com/rancher/wrangler => github.com/StrongMonkey/wrangler v0.0.0-20200815004928-43451600d957
