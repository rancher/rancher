...
replace (
	...
	github.com/rancher/types => github.com/thxcode/rancher-types v0.0.0-20191030085238-afe2ee651ed7
...
require (
	...
	github.com/rancher/rke v0.3.1-0.20191029211032-881f42341a8c
