...
require (
	...
	github.com/rancher/aks-operator v1.13.10-rc.1
	github.com/rancher/ali-operator v1.13.7-rc.1
	...
	github.com/rancher/eks-operator v1.13.10-rc.1
	github.com/rancher/fleet/pkg/apis v0.14.9
	github.com/rancher/gke-operator v1.13.11-rc.1
