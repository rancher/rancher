...
replace (
	...
	go.opentelemetry.io/otel/semconv => go.opentelemetry.io/otel/semconv v1.42.0
...
require (
	...
	github.com/rancher/fleet/pkg/apis v0.15.2-rc.3
	...
	github.com/rancher/shepherd v0.0.0-20260430211517-8ee8b260f7c4
