...
require (
	...
	github.com/rancher/shepherd v0.0.0-20251106204633-13928bf95905
	github.com/rancher/steve v0.6.47
...
replace github.com/rancher/steve => github.com/aruiz14/steve v0.0.0-20251125162044-a15b0b68cde9
