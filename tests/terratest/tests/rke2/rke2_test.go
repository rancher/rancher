...
func TestRke2DownStreamCluster(t *testing.T) {
	...
	config1 := functions.SetConfigTF(config.Rke2, config.RKE2K8sVersion1229, config.Nodes3_Etcd1_Cp1_Wkr1)
	...
	// Upgrade k8s version
	upgradedK8s := functions.SetConfigTF(config.Rke2, config.RKE2K8sVersion1236, config.Nodes3_Etcd1_Cp1_Wkr1)
	...
	config2 := functions.SetConfigTF(config.Rke2, config.RKE2K8sVersion1236, config.Nodes8_HACluster)
	...
	config3 := functions.SetConfigTF(config.Rke2, config.RKE2K8sVersion1236, config.Nodes6_Etcd3_Cp2_Wkr1)
