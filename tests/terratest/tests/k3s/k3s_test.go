...
func TestK3sDownStreamCluster(t *testing.T) {
	...
	config1 := functions.SetConfigTF(config.K3s, config.K3sK8sVersion12210, config.Nodes3_Etcd1_Cp1_Wkr1)
	...
	// Upgrade k8s version
	upgradedK8s := functions.SetConfigTF(config.K3s, config.K3sK8sVersion1237, config.Nodes3_Etcd1_Cp1_Wkr1)
	...
	config2 := functions.SetConfigTF(config.K3s, config.K3sK8sVersion1237, config.Nodes8_HACluster)
	...
	config3 := functions.SetConfigTF(config.K3s, config.K3sK8sVersion1237, config.Nodes6_Etcd3_Cp2_Wkr1)
