...
func TestRke1DownStreamCluster(t *testing.T) {
	...
	config1 := functions.SetConfigTF(config.Rke1, config.RKE1K8sVersion12210, config.Nodes3_Etcd1_Cp1_Wkr1)
	...
	// Upgrade k8s version
	upgradedK8s := functions.SetConfigTF(config.Rke1, config.RKE1K8sVersion1237, config.Nodes3_Etcd1_Cp1_Wkr1)
	...
	config2 := functions.SetConfigTF(config.Rke1, config.RKE1K8sVersion1237, config.Nodes8_HACluster)
	...
	config3 := functions.SetConfigTF(config.Rke1, config.RKE1K8sVersion1237, config.Nodes6_Etcd3_Cp2_Wkr1)
