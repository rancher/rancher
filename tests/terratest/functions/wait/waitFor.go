...
import (
	...
	wait_action "github.com/josh-diamond/rancher/tests/terratest/functions/wait/action"
	wait_state "github.com/josh-diamond/rancher/tests/terratest/functions/wait/state"
