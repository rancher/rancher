...
export SOME_K8S_VERSION=$(curl -sS https://raw.githubusercontent.com/rancher/kontainer-driver-metadata/release-v2.12/data/data.json | jq -r ".$DIST.releases[-1].version")
fi
