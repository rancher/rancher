...
export SOME_K8S_VERSION=$(curl -sS https://raw.githubusercontent.com/krunalhinguu/kontainer-driver-metadata/refs/heads/rke-eol-support/data/data.json | jq -r ".$DIST.releases[-1].version")
fi
