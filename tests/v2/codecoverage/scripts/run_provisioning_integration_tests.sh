...
export SOME_K8S_VERSION=$(curl -sS https://raw.githubusercontent.com/krunalhinguu/kontainer-driver-metadata/k8s-1.29.0/data/data.json | jq -r ".$DIST.releases[-1].version")
fi
