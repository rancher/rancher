...
export SOME_K8S_VERSION=$(curl -sS https://raw.githubusercontent.com/chiukapoor/kontainer-driver-metadata/refs/heads/v1.32-rancher/data/data.json | jq -r ".$DIST.releases[-1].version")
fi
