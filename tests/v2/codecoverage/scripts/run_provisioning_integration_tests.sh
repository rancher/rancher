...
export SOME_K8S_VERSION=$(curl -sS https://raw.githubusercontent.com/chiukapoor/kontainer-driver-metadata/rancher-v1.28/data/data.json | jq -r ".$DIST.releases[-1].version")
fi
