...
curl -sLf https://raw.githubusercontent.com/krunalhinguu/kontainer-driver-metadata/refs/heads/rke-eol-support/data/data.json > tests/v2/codecoverage/bin/data.json
