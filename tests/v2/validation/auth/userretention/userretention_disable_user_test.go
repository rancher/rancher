...
func (ur *URDisableTestSuite) TestDefaultAdminUserIsNotDisabled() {
	logrus.Info("Setting up userretention settings")
...
func (ur *URDisableTestSuite) TestStandardUserDidNotGetDisabledWithBlankSettings() {
	logrus.Info("Setting up userretention settings with blank values")
...
func (ur *URDisableTestSuite) TestStandardUserIsNotDisabledWithDryRun() {
	logrus.Info("Setting up userretention settings with dry run")
	...
	logrus.Info("userretention settings:dry run settings back to default value")
	updateUserRetentionSettings(ur.client, userRetentionDryRun, defaultSettingValue, "false")
}

func (ur *URDisableTestSuite) TestStandardUserGetDisabledWithDefaultValue() {
	logrus.Info("Setting up userretention settings")
	setupUserRetentionSettings(ur.client, "", "", "*/1 * * * *", "false")
	logrus.Info("Update userretention settings with Default value")
	updateUserRetentionSettings(ur.client, disableInactiveUserAfter, "10s", "")
...
func (ur *URDisableTestSuite) TestStandardUserGetDisabledWithDefaultValueIgnored() {
	logrus.Info("Setting up userretention settings")
	setupUserRetentionSettings(ur.client, "", "", "*/1 * * * *", "false")
	logrus.Info("Update userretention settings with Default value")
	updateUserRetentionSettings(ur.client, disableInactiveUserAfter, "20m", "10s")
...
func (ur *URDisableTestSuite) TestStandardUserDidNotGetDisabledWithDefaultValue() {
	logrus.Info("Setting up userretention settings")
	setupUserRetentionSettings(ur.client, "", "", "*/1 * * * *", "false")
	logrus.Info("Update userretention settings with Default value")
	updateUserRetentionSettings(ur.client, disableInactiveUserAfter, "10s", "20m")
