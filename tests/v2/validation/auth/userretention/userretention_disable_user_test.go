...
func (ur *URDisableTestSuite) assertBindingsEqual(before, after map[string]interface{}) {
	logrus.Info("Asserting bindings equality")
...
func (ur *URDisableTestSuite) TestDefaultAdminUserIsNotDisabled() {
	logrus.Info("Starting TestDefaultAdminUserIsNotDisabled")
...
func (ur *URDisableTestSuite) TestAdminUserGetDisabled() {
	logrus.Info("Starting TestAdminUserGetDisabled")
	logrus.Info("Setting up user retention settings")
	setupUserRetentionSettings(ur.client, "10s", "", "*/1 * * * *", "false")
	...
	bindingsBefore, err := getBindings(ur.client, newAdminUser.ID)
	...
	bindingsAfter, err := getBindings(ur.client, newAdminUser.ID)
...
func (ur *URDisableTestSuite) TestStandardUserGetDisabled() {
	logrus.Info("Starting TestStandardUserGetDisabled")
	logrus.Info("Setting up user retention settings")
	setupUserRetentionSettings(ur.client, "10s", "", "*/1 * * * *", "false")
	...
	bindingsBefore, err := getBindings(ur.client, newStdUser.ID)
	require.NoError(ur.T(), err, "Failed to get initial bindings")
	...
	bindingsAfter, err := getBindings(ur.client, newStdUser.ID)
	require.NoError(ur.T(), err, "Failed to get final bindings")
	ur.assertBindingsEqual(bindingsBefore, bindingsAfter)
}

func (ur *URDisableTestSuite) TestDisabledUserGetEnabled() {
	logrus.Info("Starting TestDisabledUserGetEnabled")
	logrus.Info("Setting up user retention settings")
	setupUserRetentionSettings(ur.client, "10s", "", "*/1 * * * *", "false")
	...
	logrus.Info("Getting final bindings")
	bindingsAfterEnabled, err := getBindings(ur.client, newStdUser.ID)
	require.NoError(ur.T(), err, "Failed to get final bindings")
...
func (ur *URDisableTestSuite) TestStandardUserDidNotGetDisabledWithBlankSettings() {
	logrus.Info("Starting TestStandardUserDidNotGetDisabledWithBlankSettings")
...
func (ur *URDisableTestSuite) TestUserDisableByUpdatingUserattributes() {
	logrus.Info("Starting TestUserDisableByUpdatingUserattributes")
	logrus.Info("Setting up user retention settings")
	setupUserRetentionSettings(ur.client, "10s", "", "*/1 * * * *", "false")
...
func (ur *URDisableTestSuite) TestUserDidNotGetDisabledWithDryRun() {
	logrus.Info("Starting TestUserDidNotGetDisabledWithDryRun")
