...
func (ur *URDeleteTestSuite) TestDefaultAdminUserIsNotDeleted() {
	logrus.Info("Starting TestDefaultAdminUserIsNotDeleted")
...
func (ur *URDeleteTestSuite) TestAdminUserGetDeleted() {
	logrus.Info("Starting TestAdminUserGetDeleted")
	logrus.Info("Setting up user retention settings")
	setupUserRetentionSettings(ur.client, "", "400h", "*/1 * * * *", "false")
	...
	assert.Equal(ur.T(), 0, len(bindingsAfter["RoleBindings"].([]rbac.RoleBinding)), "RoleBindings slice should be empty after user deletion")
...
func (ur *URDeleteTestSuite) TestStandardUserGetDeleted() {
	logrus.Info("Starting TestStandardUserGetDeleted")
	logrus.Info("Setting up user retention settings")
	setupUserRetentionSettings(ur.client, "", "400h", "*/1 * * * *", "false")
...
func (ur *URDeleteTestSuite) TestUserIsNotDeletedWithBlankSettings() {
	logrus.Info("Starting TestUserIsNotDeletedWithBlankSettings")
...
func (ur *URDeleteTestSuite) TestUserIsNotGetDeletedWithDryRun() {
	logrus.Info("Starting TestUserIsNotGetDeletedWithDryRun")
	...
	bindingsBefore, _ := getBindings(ur.client, newUser.ID)
	...
	bindingsAfter, _ := getBindings(ur.client, newUser.ID)
