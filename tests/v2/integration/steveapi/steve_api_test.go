...
var SQLOnlyListTests = []listTestType{
	...
	{
		description: "user:user-a,namespace:none,query:pagesize=8&summary=metadata.name,metadata.namespace",
		user:        "user-a",
		namespace:   "",
		query:       "pagesize=8&summary=metadata.name,metadata.namespace",
		expect: []map[string]string{
			{"name": "test1", "namespace": "test-ns-1"},
			{"name": "test2", "namespace": "test-ns-1"},
			{"name": "test3", "namespace": "test-ns-1"},
