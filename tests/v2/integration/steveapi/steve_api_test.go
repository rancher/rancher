...
var SQLOnlyListTests= []listTestType{
		// user-a
	{
		description: "user:user-a,namespace:none,query:none&summary=metadata.namespace,metadata.name",
		user:        "user-a",
		namespace:   "",
...
func (s *steveAPITestSuite) TestList() {
	...
	tests := []listTestType{
		...
		{
			description: "user:user-a,namespace:test-ns-2,query:labelSelector=test-label=2&summary=metadata.namespace,metadata.name",
			user:        "user-a",
			namespace:   "test-ns-2",
			query:       "labelSelector=test-label=2&summary=metadata.namespace,metadata.name",
			expect: []map[string]string{
				{"name": "test2", "namespace": "test-ns-2"},
			},
		},
