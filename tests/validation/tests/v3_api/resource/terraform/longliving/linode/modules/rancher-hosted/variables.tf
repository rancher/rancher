variable "load_balancers_domain" {
  type        = string
  description = "Rancher load balancerd domain"
}
...
variable "rke2_cluster_version_hosted1" {
  ...
  description = "The kubernetes version for the downstream cluster on the hosted1"
}

variable "rke2_cluster_version_hosted2" {
  type        = string
  default     = "v1.21.4+rke2r2"
  description = "The kubernetes version for the downstream cluster on the hosted2"
}

variable "rke2_cluster_version_hosted3" {
  type        = string
  default     = "v1.21.4+rke2r2"
  description = "The kubernetes version for the downstream cluster on the hosted3"
}
