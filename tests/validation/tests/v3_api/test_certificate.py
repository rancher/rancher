...
class TestCertificate:
    ...
    def test_create_certificate(self, role):
        ...
        if role in (CLUSTER_MEMBER, PROJECT_READ_ONLY):
            ...
            assert certificate_allns_valid.issuer in ['E5', 'E6'], f"Certificate issuer {certificate_allns_valid.issuer} not in allowed list"
    ...
    def test_create_namespaced_certificate(self, role):
        ...
        if role in (CLUSTER_MEMBER, PROJECT_READ_ONLY):
            ...
            assert certificate_valid.issuer in ['E5', 'E6'], f"Certificate issuer {certificate_valid.issuer} not in allowed list"
            # Delete the certificate
