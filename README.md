...
<!-- stable v2.13.2 DO NOT REMOVE THIS LINE -->
* v2.13.2 - `rancher/rancher:v2.13.2` / `rancher/rancher:stable` - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.13.2).
