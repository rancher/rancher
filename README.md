...
Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v1.3.1).
...
> Note: Our latest stable release of Rancher (v1.3.1) is tagged as `rancher/server:stable`.
