...
## Latest Release
* v2.6
  * Latest - v2.6.6 -  - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.6.6).
  * Stable - v2.6.6 -  - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.6.6).
* v2.5
  * Latest - v2.5.15 -  - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.5.15).
  * Stable - v2.5.15 -  - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.5.15).
