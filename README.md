...
Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v1.2.0).
...
> Note: Our latest stable release of Rancher (v1.2.0) is tagged as `rancher/server:latest`.
