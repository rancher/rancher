...
<!-- stable v2.13.0 DO NOT REMOVE THIS LINE -->
* v2.13
  * Stable - v2.13.0 - `rancher/rancher:v2.13.0` / `rancher/rancher:stable` - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.13.0).
* v2.12
