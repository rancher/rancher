...
## Latest Release
* v2.9
  * Latest - v2.9.2 - `rancher/rancher:v2.9.2` / `rancher/rancher:latest` - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.9.2).
  * Stable - v2.9.2 - `rancher/rancher:v2.9.2` / `rancher/rancher:stable` - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.9.2).
* v2.8
