...
Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v1.2.0-pre3).
...
> Note: Our latest stable release of Rancher (v1.1.4) is tagged as `rancher/server:latest`. Users will need to tag any specific development builds (i.e. anything tagged with `preX`) to get the specific development version. 
