...
## Latest Release
* v2.6
  * Latest - v2.6.8 - `rancher/rancher:v2.6.9` / `rancher/rancher:latest` - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.6.9).
  * Stable - v2.6.8 - `rancher/rancher:v2.6.9` / `rancher/rancher:stable` - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.6.9).
* v2.5
