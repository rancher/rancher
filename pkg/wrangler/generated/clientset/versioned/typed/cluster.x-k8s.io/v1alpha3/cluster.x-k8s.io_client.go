...
func NewForConfig(c *rest.Config) (*ClusterV1alpha3Client, error) {
	config := *c
	...
	return &ClusterV1alpha3Client{client}, nil
}

// NewForConfigOrDie creates a new ClusterV1alpha3Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *ClusterV1alpha3Client {
...
// New creates a new ClusterV1alpha3Client for the given RESTClient.
func New(c rest.Interface) *ClusterV1alpha3Client {
	return &ClusterV1alpha3Client{c}
}
...
func (c *ClusterV1alpha3Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
