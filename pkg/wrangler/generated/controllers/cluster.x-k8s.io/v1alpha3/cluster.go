...
func (c *clusterController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v1alpha3.Cluster, error) {
	result := &v1alpha3.Cluster{}
...
func (c *clusterCache) List(namespace string, selector labels.Selector) (ret []*v1alpha3.Cluster, err error) {
