...
func (in *RKEClusterSpecCommon) DeepCopyInto(out *RKEClusterSpecCommon) {
	*out = *in
	...
	if in.MachineSelectorFiles != nil {
		...
		*out = make([]RKESystemFiles, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RKESystemFiles) DeepCopyInto(out *RKESystemFiles) {
	*out = *in
	if in.MachineLabelSelector != nil {
		in, out := &in.MachineLabelSelector, &out.MachineLabelSelector
		*out = new(metav1.LabelSelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RKESystemFiles.
func (in *RKESystemFiles) DeepCopy() *RKESystemFiles {
	if in == nil {
		return nil
	}
	out := new(RKESystemFiles)
	in.DeepCopyInto(out)
	return out
}
