...
type ClusterSpec struct {
	...
	// ClusterAPIConfig is deprecated and will be removed in a future version.
	// +optional
	...
	// DefaultPodSecurityAdmissionConfigurationTemplateName is the name of the default psact to use when generating a pod security admissions config file for the cluster.
	// The rancher-webhook will generate a secret containing the rendered AdmissionConfiguration resource as yaml, and create a machineSelectorFile at
	// /etc/rancher/k3s/config/rancher-psact.yaml and /etc/rancher/rke2/config/rancher-psact.yaml for K3s and RKE2 respectively.
	// +optional
...
type ClusterAPIConfig struct {
	// ClusterName is deprecated and will be removed in a future version.
	// Deprecated:
	// +optional
