...
type Condition struct {
	...
	// lastUpdateTime of this condition. This is incremented if the resource is updated for any reason.
	// This could be when the underlying condition changed, but may also be updated if other fields are
	// modified (Message, Reason, etc.).
	// +optional
