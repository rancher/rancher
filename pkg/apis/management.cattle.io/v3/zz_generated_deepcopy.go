...
func (in *CredentialInjectionSpec) DeepCopyInto(out *CredentialInjectionSpec) {
	*out = *in
	if in.Fields != nil {
		...
		*out = make([]InjectionFieldMapping, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InjectionFieldMapping) DeepCopyInto(out *InjectionFieldMapping) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InjectionFieldMapping.
func (in *InjectionFieldMapping) DeepCopy() *InjectionFieldMapping {
	if in == nil {
		return nil
	}
	out := new(InjectionFieldMapping)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProxyEndpointRoute) DeepCopyInto(out *ProxyEndpointRoute) {
	*out = *in
	...
	if in.TLSVerificationOptions != nil {
		in, out := &in.TLSVerificationOptions, &out.TLSVerificationOptions
...
func (in *TLSVerificationSpec) DeepCopyInto(out *TLSVerificationSpec) {
	*out = *in
	if in.VerifyHostname != nil {
		in, out := &in.VerifyHostname, &out.VerifyHostname
		*out = new(bool)
		**out = **in
	}
