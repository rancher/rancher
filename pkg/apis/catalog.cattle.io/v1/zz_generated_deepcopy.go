...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OCIOptions) DeepCopyInto(out *OCIOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OCIOptions.
func (in *OCIOptions) DeepCopy() *OCIOptions {
	if in == nil {
		return nil
	}
	out := new(OCIOptions)
...
func (in *RepoSpec) DeepCopyInto(out *RepoSpec) {
	*out = *in
	...
	if in.OCIOptions != nil {
		in, out := &in.OCIOptions, &out.OCIOptions
		*out = new(OCIOptions)
		**out = **in
	}
	if in.CABundle != nil {
...
func (in *UIPluginStatus) DeepCopyInto(out *UIPluginStatus) {
	*out = *in
	in.RetryAt.DeepCopyInto(&out.RetryAt)
	return
}
