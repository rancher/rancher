...
func addMachineDrivers(management *config.ManagementContext) error {
	...
	if err := addMachineDriver(HarvesterDriver, "https://releases.rancher.com/harvester-node-driver/v0.6.9/docker-machine-driver-harvester-amd64.tar.gz", "", "76e1aeb778709e7350ce51f5252e87943ddcc914ad65ac487baa505c93b8e9f7", []string{"releases.rancher.com"}, harvesterEnabled, harvesterEnabled, false, management); err != nil {
		return err
	}
	linodeBuiltin := true
