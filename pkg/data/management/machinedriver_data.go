...
func addMachineDrivers(management *config.ManagementContext) error {
	...
	if err := addMachineDriver(HarvesterDriver, "https://releases.rancher.com/harvester-node-driver/v0.4.0/docker-machine-driver-harvester-amd64.tar.gz", "", "9bf5a6817757064abbc2eb97b0ed20fd18c66e851b1615a49cd29ae07ce6d9b0", []string{"releases.rancher.com"}, harvesterEnabled, harvesterEnabled, false, management); err != nil {
		return err
	}
	linodeBuiltin := true
	...
	if err := addMachineDriver(PhoenixNAPDriver, "https://github.com/phoenixnap/docker-machine-driver-pnap/releases/download/v0.3.0/docker-machine-driver-pnap_0.3.0_linux_amd64.zip", "", "50c292359b2de9e842cb88d2e881f7bbcc110402fc1ad63900b7f30d8f291a7e", []string{"api.securedservers.com", "api.phoenixnap.com"}, false, false, false, management); err != nil {
		return err
	}
