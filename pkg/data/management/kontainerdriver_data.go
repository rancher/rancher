...
func addKontainerDrivers(management *config.ManagementContext) error {
	...
	if err := creator.addCustomDriver(
		...
		"https://github.com/rancher-plugins/kontainer-engine-driver-oke/releases/download/v1.8.7/kontainer-engine-driver-oke-linux",
		"2631ee7677b1af8cb96a6c2cdc07611229eb04867e002b03b7f4619d4f665ff1",
		"",
		false,
		"*.oraclecloud.com",
	); err != nil {
	...
	if err := creator.addCustomDriver(
		...
		"https://github.com/linode/kontainer-engine-driver-lke/releases/download/v0.0.11/kontainer-engine-driver-lke-linux-amd64",
		"0051aab5d5562d341dd9cddb22534a6edd0cd17ba4bc3df700fccbfd2bacead7",
		"",
		false,
		"api.linode.com",
	); err != nil {
