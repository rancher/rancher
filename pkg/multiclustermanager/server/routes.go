...
import (
	...
	auth2 "github.com/rancher/rancher/pkg/auth"
	...
	"github.com/rancher/rancher/pkg/multiclustermanager/api/norman/customization/oci"
	"github.com/rancher/rancher/pkg/multiclustermanager/api/norman/customization/vsphere"
	managementapi "github.com/rancher/rancher/pkg/multiclustermanager/api/norman/server"
	"github.com/rancher/rancher/pkg/multiclustermanager/capabilities"
	"github.com/rancher/rancher/pkg/multiclustermanager/channelserver"
	"github.com/rancher/rancher/pkg/multiclustermanager/clustermanager"
	rancherdialer "github.com/rancher/rancher/pkg/multiclustermanager/dialer"
	"github.com/rancher/rancher/pkg/multiclustermanager/httpproxy"
	k8sProxyPkg "github.com/rancher/rancher/pkg/multiclustermanager/k8sproxy"
	"github.com/rancher/rancher/pkg/multiclustermanager/metrics"
	"github.com/rancher/rancher/pkg/multiclustermanager/pipeline/hooks"
	"github.com/rancher/rancher/pkg/multiclustermanager/rbac"
	"github.com/rancher/rancher/pkg/multiclustermanager/rkenodeconfigserver"
...
func router(ctx context.Context, localClusterEnabled bool, scaledContext *config.ScaledContext, clusterManager *clustermanager.Manager) (func(http.Handler) http.Handler, error) {
	...
	tokenAPI, err := tokens.NewAPIHandler(ctx, scaledContext, auth2.ConfigureAPIUI)
	if err != nil {
		return nil, err
	}

	publicAPI, err := publicapi.NewHandler(ctx, scaledContext, auth2.ConfigureAPIUI)
	if err != nil {
		return nil, err
	}
