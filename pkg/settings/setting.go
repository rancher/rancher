...
var (
	...
	EngineInstallURL                    = NewSetting("engine-install-url", "https://releases.rancher.com/install-docker/27.4.sh")
	...
	EngineSupportedRange                = NewSetting("engine-supported-range", "~v1.11.2 || ~v1.12.0 || ~v1.13.0 || ~v17.03.0 || ~v17.06.0 || ~v17.09.0 || ~v18.06.0 || ~v18.09.0 || ~v19.03.0 || ~v20.10.0 || ~v23.0.0 || ~v24.0.0 || ~v25.0.0 || ~v26.0.0 || ~v26.1.0 || ~v27.0.0 || ~v27.1.0 || ~v27.2.0 || ~v27.3.0 || ~v27.4.0")
	...
	WinsAgentInstallScript              = NewSetting("wins-agent-install-script", "https://raw.githubusercontent.com/rancher/wins/v0.4.21-rc.2/install.ps1")
