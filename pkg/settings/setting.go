...
var (
	...
	UIDashboardIndex                  = NewSetting("ui-dashboard-index", "https://releases.rancher.com/dashboard/release-2.6.3-patch3/index.html")
	...
	ChartDefaultBranch                = NewSetting("chart-default-branch", "release-v2.6.3-patch1")
