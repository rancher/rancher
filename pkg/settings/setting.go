...
var (
	...
	ShellImage                          = NewSetting("shell-image", "rancher/shell:v0.1.25")
	...
	UIDashboardIndex = NewSetting("ui-dashboard-index", "https://releases.rancher.com/dashboard/release-2.7.patch1/index.html")
