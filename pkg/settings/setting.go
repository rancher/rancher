...
var (
	...
	WinsAgentInstallScript              = NewSetting("wins-agent-install-script", "https://raw.githubusercontent.com/rancher/wins/v0.3.1/install.ps1")
	...
	ShellImage                          = NewSetting("shell-image", "rancher/shell:v0.1.18-rc7")
	...
	MachineProvisionImage               = NewSetting("machine-provision-image", "rancher/machine:v0.15.0-rancher90")
