...
var (
	...
	KDMBranch                           = NewSetting("kdm-branch", "release-v2.12")
	...
	WinsAgentInstallScript              = NewSetting("wins-agent-install-script", "https://raw.githubusercontent.com/rancher/wins/v0.12.1-rc.2/install.ps1")
	...
	ChartDefaultBranch                  = NewSetting("chart-default-branch", "release-v2.12")
	...
	MachineProvisionImage               = NewSetting("machine-provision-image", "rancher/machine:v0.15.0-rancher133.2")
