...
usage () {
    ...
    echo "  [--windows-versions version] Comma separated Windows versions. e.g., \"1809\". (Default \"1809\")"
...
function usage {
    ...
    echo "  [-i|--images path] tar.gz generated by docker save."
    echo "  [-r|--registry registry:port] target private registry:port."
    echo "  [-o|--os-release-id (1809)] release id of OS, gets detected automatically if not passed."
    echo "  [-h|--help] Usage message."
}
