...
type Manager interface {
	...
	EnsureToken(tokenName, description, kind, userName string, ttl *int64) (string, func(), error)
	EnsureClusterToken(clusterName, tokenName, description, kind, userName string, ttl *int64) (string, func(), error)
