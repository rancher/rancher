...
//
//	mockgen -write_generate_directive=true -destination zz_manager_mocks.go -package mocks .. Manager
//
...
//go:generate mockgen -write_generate_directive=true -destination zz_manager_mocks.go -package mocks .. Manager
