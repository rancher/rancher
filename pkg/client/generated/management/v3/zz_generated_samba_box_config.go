...
const (
	SambaBoxConfigType                              = "sambaBoxConfig"
	SambaBoxConfigFieldAccessMode                   = "accessMode"
	SambaBoxConfigFieldAllowedPrincipalIDs          = "allowedPrincipalIds"
	SambaBoxConfigFieldAnnotations                  = "annotations"
	SambaBoxConfigFieldCertificate                  = "certificate"
	SambaBoxConfigFieldConnectionTimeout            = "connectionTimeout"
	SambaBoxConfigFieldCreated                      = "created"
	SambaBoxConfigFieldCreatorID                    = "creatorId"
	SambaBoxConfigFieldDefaultLoginDomain           = "defaultLoginDomain"
	SambaBoxConfigFieldEnabled                      = "enabled"
	SambaBoxConfigFieldGroupDNAttribute             = "groupDNAttribute"
	SambaBoxConfigFieldGroupMemberMappingAttribute  = "groupMemberMappingAttribute"
	SambaBoxConfigFieldGroupMemberUserAttribute     = "groupMemberUserAttribute"
	SambaBoxConfigFieldGroupNameAttribute           = "groupNameAttribute"
	SambaBoxConfigFieldGroupObjectClass             = "groupObjectClass"
	SambaBoxConfigFieldGroupSearchAttribute         = "groupSearchAttribute"
	SambaBoxConfigFieldGroupSearchBase              = "groupSearchBase"
	SambaBoxConfigFieldGroupSearchFilter            = "groupSearchFilter"
	SambaBoxConfigFieldLabels                       = "labels"
	SambaBoxConfigFieldName                         = "name"
	SambaBoxConfigFieldNestedGroupMembershipEnabled = "nestedGroupMembershipEnabled"
	SambaBoxConfigFieldOwnerReferences              = "ownerReferences"
	SambaBoxConfigFieldPort                         = "port"
	SambaBoxConfigFieldRemoved                      = "removed"
	SambaBoxConfigFieldServers                      = "servers"
	SambaBoxConfigFieldServiceAccountPassword       = "serviceAccountPassword"
	SambaBoxConfigFieldServiceAccountUsername       = "serviceAccountUsername"
	SambaBoxConfigFieldStartTLS                     = "starttls"
	SambaBoxConfigFieldTLS                          = "tls"
	SambaBoxConfigFieldType                         = "type"
	SambaBoxConfigFieldUUID                         = "uuid"
	SambaBoxConfigFieldUserDisabledBitMask          = "userDisabledBitMask"
	SambaBoxConfigFieldUserEnabledAttribute         = "userEnabledAttribute"
	SambaBoxConfigFieldUserLoginAttribute           = "userLoginAttribute"
	SambaBoxConfigFieldUserNameAttribute            = "userNameAttribute"
	SambaBoxConfigFieldUserObjectClass              = "userObjectClass"
	SambaBoxConfigFieldUserSearchAttribute          = "userSearchAttribute"
	SambaBoxConfigFieldUserSearchBase               = "userSearchBase"
	SambaBoxConfigFieldUserSearchFilter             = "userSearchFilter"
)
