...
func TestTokenAuthenticatorAuthenticateExtToken(t *testing.T) {
	...
	store := exttokenstore.NewSystemTokenStore(nil, secrets, nil, nil, nil)
	...
	t.Run("error updating lastUsedAt doesn't fail the request", func(t *testing.T) {
		...
		authenticator.extTokenStore = exttokenstore.NewSystemTokenStore(nil, newSecrets, nil, nil, nil)
