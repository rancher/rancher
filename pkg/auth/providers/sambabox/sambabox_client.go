...
func (p *adProvider) loginUser(adCredential *v32.BasicLogin, config *v32.SambaBoxConfig, caPool *x509.CertPool, testServiceAccountBind bool) (v3.Principal, []v3.Principal, error) {
	...
	search := ldapv2.NewSearchRequest(config.UserSearchBase,
		...
		query,
		ldap.GetUserSearchAttributesForSBX(MemberOfAttribute, ObjectClass, config), nil)
...
func (p *adProvider) RefetchGroupPrincipals(principalID string, secret string) ([]v3.Principal, error) {
	config, caPool, err := p.getSambaBoxConfig()
	if err != nil {
		return nil, err
	}
	...
	search := ldapv2.NewSearchRequest(
		...
		ldap.GetUserSearchAttributesForSBX(MemberOfAttribute, ObjectClass, config),
		nil,
	)
...
func (p *adProvider) getPrincipalsFromSearchResult(result *ldapv2.SearchResult, config *v32.SambaBoxConfig, lConn *ldapv2.Conn) (v3.Principal, []v3.Principal, error) {
...
func (p *adProvider) getGroupPrincipalsFromSearch(searchBase string, filter string, config *v32.SambaBoxConfig, lConn *ldapv2.Conn,
	...
	search := ldapv2.NewSearchRequest(searchBase,
		ldapv2.ScopeWholeSubtree, ldapv2.NeverDerefAliases, 0, 0, false,
		filter,
		ldap.GetGroupSearchAttributesForSBX(MemberOfAttribute, ObjectClass, config), nil)
...
func (p *adProvider) getPrincipal(distinguishedName string, scope string, config *v32.SambaBoxConfig, caPool *x509.CertPool) (*v3.Principal, error) {
...
func (p *adProvider) searchPrincipals(name, principalType string, config *v32.SambaBoxConfig, lConn *ldapv2.Conn) ([]v3.Principal, error) {
...
func (p *adProvider) searchUser(name string, config *v32.SambaBoxConfig, lConn *ldapv2.Conn) ([]v3.Principal, error) {
...
func (p *adProvider) searchGroup(name string, config *v32.SambaBoxConfig, lConn *ldapv2.Conn) ([]v3.Principal, error) {
...
func (p *adProvider) searchLdap(query string, scope string, config *v32.SambaBoxConfig, lConn *ldapv2.Conn) ([]v3.Principal, error) {
	var principals []v3.Principal
	var search *ldapv2.SearchRequest
...
func (p *adProvider) ldapConnection(config *v32.SambaBoxConfig, caPool *x509.CertPool) (*ldapv2.Conn, error) {
...
func (p *adProvider) permissionCheck(attributes []*ldapv2.EntryAttribute, config *v32.SambaBoxConfig) bool {
	userObjectClass := config.UserObjectClass
