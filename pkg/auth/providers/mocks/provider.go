...
func (m *MockAuthProvider) AuthenticateUser(ctx context.Context, apiContext *types.APIContext, input any) (v3.Principal, []v3.Principal, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AuthenticateUser", ctx, apiContext, input)
...
func (mr *MockAuthProviderMockRecorder) AuthenticateUser(ctx, apiContext, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AuthenticateUser", reflect.TypeOf((*MockAuthProvider)(nil).AuthenticateUser), ctx, apiContext, input)
}
