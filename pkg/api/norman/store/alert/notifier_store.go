...
func getSMTPConfig(data map[string]interface{}) (*v3.SMTPConfig, error) {
	smtpConfig, err := getConfig(data, "smtpConfig", &v3.SMTPConfig{})
	if err != nil || smtpConfig == nil {
		return nil, err
	}
	return smtpConfig.(*v3.SMTPConfig), nil
}

func getWechatConfig(data map[string]interface{}) (*v3.WechatConfig, error) {
	wechatConfig, err := getConfig(data, "wechatConfig", &v3.WechatConfig{})
	if err != nil || wechatConfig == nil {
		return nil, err
	}
	return wechatConfig.(*v3.WechatConfig), nil
}

func getDingtalkConfig(data map[string]interface{}) (*v3.DingtalkConfig, error) {
	dingtalkConfig, err := getConfig(data, "dingtalkConfig", &v3.DingtalkConfig{})
	if err != nil || dingtalkConfig == nil {
		return nil, err
	}
	return dingtalkConfig.(*v3.DingtalkConfig), nil
}
