...
func (h *handler) ServeHTTP(writer http.ResponseWriter, req *http.Request) {
	...
	if credID := req.URL.Query().Get("cloudCredentialId"); credID != "" {
		...
		ak = string(cc.Data["alibabacredentialConfig-accessKeyId"])
		sk = string(cc.Data["alibabacredentialConfig-accessKeySecret"])
	} else {
	...
	switch resourceType {
	case "alibabaRegions":
		if serialized, errCode, err = describeRegions(ak, sk, regionId, req); err != nil {
	...
	case "alibabaClusters":
		if serialized, errCode, err = describeClusters(ak, sk, regionId, req); err != nil {
	...
	case "alibabaResourceGroups":
		if serialized, errCode, err = describeResourceGroups(ak, sk, regionId, req); err != nil {
	...
	case "alibabaInstanceTypes":
		if serialized, errCode, err = describeInstanceTypes(ak, sk, regionId, req); err != nil {
	...
	case "alibabaKeyPairs":
		if serialized, errCode, err = describeKeyPairs(ak, sk, regionId, req); err != nil {
		...
		writer.Write(serialized)
	case "alibabaVpcs":
		if serialized, errCode, err = describeVpcs(ak, sk, regionId, req); err != nil {
	...
	case "alibabaVSwitches":
		if serialized, errCode, err = describeVSwitches(ak, sk, regionId, req); err != nil {
	...
	case "alibabaAvailableResources":
		if serialized, errCode, err = describeAvailableResource(ak, sk, regionId, req); err != nil {
	...
	case "alibabaKubernetesVersions":
		if serialized, errCode, err = describeKubernetesMetadata(ak, sk, regionId, req); err != nil {
