...
// Ensure, that ClusterAuthTokenListerMock does implement v3.ClusterAuthTokenLister.
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterAuthTokenLister = &ClusterAuthTokenListerMock{}

// ClusterAuthTokenListerMock is a mock implementation of v3.ClusterAuthTokenLister.
//
//     func TestSomethingThatUsesClusterAuthTokenLister(t *testing.T) {
//
//         // make and configure a mocked v3.ClusterAuthTokenLister
...
//         }
//
//         // use mockedClusterAuthTokenLister in code that requires v3.ClusterAuthTokenLister
...
// Ensure, that ClusterAuthTokenControllerMock does implement v3.ClusterAuthTokenController.
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterAuthTokenController = &ClusterAuthTokenControllerMock{}

// ClusterAuthTokenControllerMock is a mock implementation of v3.ClusterAuthTokenController.
//
//     func TestSomethingThatUsesClusterAuthTokenController(t *testing.T) {
//
//         // make and configure a mocked v3.ClusterAuthTokenController
...
//             },
//             AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.ClusterAuthTokenHandlerFunc)  {
...
//         }
//
//         // use mockedClusterAuthTokenController in code that requires v3.ClusterAuthTokenController
//         // and then make assertions.
//
//     }
...
func (mock *ClusterAuthTokenControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.ClusterAuthTokenHandlerFunc) {
...
// Ensure, that ClusterAuthTokenInterfaceMock does implement v3.ClusterAuthTokenInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterAuthTokenInterface = &ClusterAuthTokenInterfaceMock{}

// ClusterAuthTokenInterfaceMock is a mock implementation of v3.ClusterAuthTokenInterface.
//
//     func TestSomethingThatUsesClusterAuthTokenInterface(t *testing.T) {
//
//         // make and configure a mocked v3.ClusterAuthTokenInterface
//         mockedClusterAuthTokenInterface := &ClusterAuthTokenInterfaceMock{
//             AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.ClusterAuthTokenHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
...
//             },
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, syncMoqParam v3.ClusterAuthTokenHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
...
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, syncMoqParam v3.ClusterAuthTokenHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
...
//         }
//
//         // use mockedClusterAuthTokenInterface in code that requires v3.ClusterAuthTokenInterface
//         // and then make assertions.
//
//     }
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *ClusterAuthTokenInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.ClusterAuthTokenHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *ClusterAuthTokenInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, syncMoqParam v3.ClusterAuthTokenHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *ClusterAuthTokenInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.ClusterAuthTokenHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
// AddHandler calls AddHandlerFunc.
func (mock *ClusterAuthTokenInterfaceMock) AddHandler(ctx context.Context, name string, syncMoqParam v3.ClusterAuthTokenHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
// Ensure, that ClusterAuthTokensGetterMock does implement v3.ClusterAuthTokensGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterAuthTokensGetter = &ClusterAuthTokensGetterMock{}

// ClusterAuthTokensGetterMock is a mock implementation of v3.ClusterAuthTokensGetter.
//
//     func TestSomethingThatUsesClusterAuthTokensGetter(t *testing.T) {
//
//         // make and configure a mocked v3.ClusterAuthTokensGetter
...
//         }
//
//         // use mockedClusterAuthTokensGetter in code that requires v3.ClusterAuthTokensGetter
//         // and then make assertions.
//
//     }
