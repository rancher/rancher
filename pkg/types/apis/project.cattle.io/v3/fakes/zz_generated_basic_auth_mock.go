...
// Ensure, that BasicAuthListerMock does implement v3.BasicAuthLister.
// If this is not the case, regenerate this file with moq.
var _ v3.BasicAuthLister = &BasicAuthListerMock{}

// BasicAuthListerMock is a mock implementation of v3.BasicAuthLister.
//
//     func TestSomethingThatUsesBasicAuthLister(t *testing.T) {
//
//         // make and configure a mocked v3.BasicAuthLister
...
//         }
//
//         // use mockedBasicAuthLister in code that requires v3.BasicAuthLister
...
// Ensure, that BasicAuthControllerMock does implement v3.BasicAuthController.
// If this is not the case, regenerate this file with moq.
var _ v3.BasicAuthController = &BasicAuthControllerMock{}

// BasicAuthControllerMock is a mock implementation of v3.BasicAuthController.
//
//     func TestSomethingThatUsesBasicAuthController(t *testing.T) {
//
//         // make and configure a mocked v3.BasicAuthController
...
//             },
//             AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.BasicAuthHandlerFunc)  {
...
//         }
//
//         // use mockedBasicAuthController in code that requires v3.BasicAuthController
//         // and then make assertions.
//
//     }
...
func (mock *BasicAuthControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.BasicAuthHandlerFunc) {
...
// Ensure, that BasicAuthInterfaceMock does implement v3.BasicAuthInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.BasicAuthInterface = &BasicAuthInterfaceMock{}

// BasicAuthInterfaceMock is a mock implementation of v3.BasicAuthInterface.
//
//     func TestSomethingThatUsesBasicAuthInterface(t *testing.T) {
//
//         // make and configure a mocked v3.BasicAuthInterface
//         mockedBasicAuthInterface := &BasicAuthInterfaceMock{
//             AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.BasicAuthHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
...
//             },
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, syncMoqParam v3.BasicAuthHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
...
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, syncMoqParam v3.BasicAuthHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
...
//         }
//
//         // use mockedBasicAuthInterface in code that requires v3.BasicAuthInterface
//         // and then make assertions.
//
//     }
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *BasicAuthInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.BasicAuthHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *BasicAuthInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, syncMoqParam v3.BasicAuthHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *BasicAuthInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.BasicAuthHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
// AddHandler calls AddHandlerFunc.
func (mock *BasicAuthInterfaceMock) AddHandler(ctx context.Context, name string, syncMoqParam v3.BasicAuthHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
// Ensure, that BasicAuthsGetterMock does implement v3.BasicAuthsGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.BasicAuthsGetter = &BasicAuthsGetterMock{}

// BasicAuthsGetterMock is a mock implementation of v3.BasicAuthsGetter.
//
//     func TestSomethingThatUsesBasicAuthsGetter(t *testing.T) {
//
//         // make and configure a mocked v3.BasicAuthsGetter
...
//         }
//
//         // use mockedBasicAuthsGetter in code that requires v3.BasicAuthsGetter
//         // and then make assertions.
//
//     }
