...
// Ensure, that PipelineListerMock does implement v3.PipelineLister.
// If this is not the case, regenerate this file with moq.
var _ v3.PipelineLister = &PipelineListerMock{}

// PipelineListerMock is a mock implementation of v3.PipelineLister.
//
//     func TestSomethingThatUsesPipelineLister(t *testing.T) {
//
//         // make and configure a mocked v3.PipelineLister
...
//         }
//
//         // use mockedPipelineLister in code that requires v3.PipelineLister
...
// Ensure, that PipelineControllerMock does implement v3.PipelineController.
// If this is not the case, regenerate this file with moq.
var _ v3.PipelineController = &PipelineControllerMock{}

// PipelineControllerMock is a mock implementation of v3.PipelineController.
//
//     func TestSomethingThatUsesPipelineController(t *testing.T) {
//
//         // make and configure a mocked v3.PipelineController
...
//             },
//             AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.PipelineHandlerFunc)  {
...
//         }
//
//         // use mockedPipelineController in code that requires v3.PipelineController
//         // and then make assertions.
//
//     }
...
func (mock *PipelineControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.PipelineHandlerFunc) {
...
// Ensure, that PipelineInterfaceMock does implement v3.PipelineInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.PipelineInterface = &PipelineInterfaceMock{}

// PipelineInterfaceMock is a mock implementation of v3.PipelineInterface.
//
//     func TestSomethingThatUsesPipelineInterface(t *testing.T) {
//
//         // make and configure a mocked v3.PipelineInterface
//         mockedPipelineInterface := &PipelineInterfaceMock{
//             AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.PipelineHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
...
//             },
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, syncMoqParam v3.PipelineHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
...
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, syncMoqParam v3.PipelineHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
...
//         }
//
//         // use mockedPipelineInterface in code that requires v3.PipelineInterface
//         // and then make assertions.
//
//     }
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *PipelineInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.PipelineHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *PipelineInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, syncMoqParam v3.PipelineHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *PipelineInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.PipelineHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
// AddHandler calls AddHandlerFunc.
func (mock *PipelineInterfaceMock) AddHandler(ctx context.Context, name string, syncMoqParam v3.PipelineHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
// Ensure, that PipelinesGetterMock does implement v3.PipelinesGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.PipelinesGetter = &PipelinesGetterMock{}

// PipelinesGetterMock is a mock implementation of v3.PipelinesGetter.
//
//     func TestSomethingThatUsesPipelinesGetter(t *testing.T) {
//
//         // make and configure a mocked v3.PipelinesGetter
...
//         }
//
//         // use mockedPipelinesGetter in code that requires v3.PipelinesGetter
//         // and then make assertions.
//
//     }
