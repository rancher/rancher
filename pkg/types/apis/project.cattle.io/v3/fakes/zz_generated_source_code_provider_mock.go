...
// Ensure, that SourceCodeProviderListerMock does implement v3.SourceCodeProviderLister.
// If this is not the case, regenerate this file with moq.
var _ v3.SourceCodeProviderLister = &SourceCodeProviderListerMock{}

// SourceCodeProviderListerMock is a mock implementation of v3.SourceCodeProviderLister.
//
//     func TestSomethingThatUsesSourceCodeProviderLister(t *testing.T) {
//
//         // make and configure a mocked v3.SourceCodeProviderLister
...
//         }
//
//         // use mockedSourceCodeProviderLister in code that requires v3.SourceCodeProviderLister
...
// Ensure, that SourceCodeProviderControllerMock does implement v3.SourceCodeProviderController.
// If this is not the case, regenerate this file with moq.
var _ v3.SourceCodeProviderController = &SourceCodeProviderControllerMock{}

// SourceCodeProviderControllerMock is a mock implementation of v3.SourceCodeProviderController.
//
//     func TestSomethingThatUsesSourceCodeProviderController(t *testing.T) {
//
//         // make and configure a mocked v3.SourceCodeProviderController
...
//             },
//             AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.SourceCodeProviderHandlerFunc)  {
...
//         }
//
//         // use mockedSourceCodeProviderController in code that requires v3.SourceCodeProviderController
//         // and then make assertions.
//
//     }
...
func (mock *SourceCodeProviderControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.SourceCodeProviderHandlerFunc) {
...
// Ensure, that SourceCodeProviderInterfaceMock does implement v3.SourceCodeProviderInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.SourceCodeProviderInterface = &SourceCodeProviderInterfaceMock{}

// SourceCodeProviderInterfaceMock is a mock implementation of v3.SourceCodeProviderInterface.
//
//     func TestSomethingThatUsesSourceCodeProviderInterface(t *testing.T) {
//
//         // make and configure a mocked v3.SourceCodeProviderInterface
//         mockedSourceCodeProviderInterface := &SourceCodeProviderInterfaceMock{
//             AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.SourceCodeProviderHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
...
//             },
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, syncMoqParam v3.SourceCodeProviderHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
...
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, syncMoqParam v3.SourceCodeProviderHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
...
//         }
//
//         // use mockedSourceCodeProviderInterface in code that requires v3.SourceCodeProviderInterface
//         // and then make assertions.
//
//     }
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *SourceCodeProviderInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.SourceCodeProviderHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *SourceCodeProviderInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, syncMoqParam v3.SourceCodeProviderHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *SourceCodeProviderInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.SourceCodeProviderHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
// AddHandler calls AddHandlerFunc.
func (mock *SourceCodeProviderInterfaceMock) AddHandler(ctx context.Context, name string, syncMoqParam v3.SourceCodeProviderHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
// Ensure, that SourceCodeProvidersGetterMock does implement v3.SourceCodeProvidersGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.SourceCodeProvidersGetter = &SourceCodeProvidersGetterMock{}

// SourceCodeProvidersGetterMock is a mock implementation of v3.SourceCodeProvidersGetter.
//
//     func TestSomethingThatUsesSourceCodeProvidersGetter(t *testing.T) {
//
//         // make and configure a mocked v3.SourceCodeProvidersGetter
...
//         }
//
//         // use mockedSourceCodeProvidersGetter in code that requires v3.SourceCodeProvidersGetter
//         // and then make assertions.
//
//     }
