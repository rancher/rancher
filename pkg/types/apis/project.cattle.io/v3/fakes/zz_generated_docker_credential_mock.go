...
// Ensure, that DockerCredentialListerMock does implement v3.DockerCredentialLister.
// If this is not the case, regenerate this file with moq.
var _ v3.DockerCredentialLister = &DockerCredentialListerMock{}

// DockerCredentialListerMock is a mock implementation of v3.DockerCredentialLister.
//
//     func TestSomethingThatUsesDockerCredentialLister(t *testing.T) {
//
//         // make and configure a mocked v3.DockerCredentialLister
...
//         }
//
//         // use mockedDockerCredentialLister in code that requires v3.DockerCredentialLister
...
// Ensure, that DockerCredentialControllerMock does implement v3.DockerCredentialController.
// If this is not the case, regenerate this file with moq.
var _ v3.DockerCredentialController = &DockerCredentialControllerMock{}

// DockerCredentialControllerMock is a mock implementation of v3.DockerCredentialController.
//
//     func TestSomethingThatUsesDockerCredentialController(t *testing.T) {
//
//         // make and configure a mocked v3.DockerCredentialController
...
//             },
//             AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.DockerCredentialHandlerFunc)  {
...
//         }
//
//         // use mockedDockerCredentialController in code that requires v3.DockerCredentialController
//         // and then make assertions.
//
//     }
...
func (mock *DockerCredentialControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.DockerCredentialHandlerFunc) {
...
// Ensure, that DockerCredentialInterfaceMock does implement v3.DockerCredentialInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.DockerCredentialInterface = &DockerCredentialInterfaceMock{}

// DockerCredentialInterfaceMock is a mock implementation of v3.DockerCredentialInterface.
//
//     func TestSomethingThatUsesDockerCredentialInterface(t *testing.T) {
//
//         // make and configure a mocked v3.DockerCredentialInterface
//         mockedDockerCredentialInterface := &DockerCredentialInterfaceMock{
//             AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.DockerCredentialHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
...
//             },
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, syncMoqParam v3.DockerCredentialHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
...
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, syncMoqParam v3.DockerCredentialHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
...
//         }
//
//         // use mockedDockerCredentialInterface in code that requires v3.DockerCredentialInterface
//         // and then make assertions.
//
//     }
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *DockerCredentialInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.DockerCredentialHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *DockerCredentialInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, syncMoqParam v3.DockerCredentialHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *DockerCredentialInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.DockerCredentialHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
// AddHandler calls AddHandlerFunc.
func (mock *DockerCredentialInterfaceMock) AddHandler(ctx context.Context, name string, syncMoqParam v3.DockerCredentialHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
// Ensure, that DockerCredentialsGetterMock does implement v3.DockerCredentialsGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.DockerCredentialsGetter = &DockerCredentialsGetterMock{}

// DockerCredentialsGetterMock is a mock implementation of v3.DockerCredentialsGetter.
//
//     func TestSomethingThatUsesDockerCredentialsGetter(t *testing.T) {
//
//         // make and configure a mocked v3.DockerCredentialsGetter
...
//         }
//
//         // use mockedDockerCredentialsGetter in code that requires v3.DockerCredentialsGetter
//         // and then make assertions.
//
//     }
