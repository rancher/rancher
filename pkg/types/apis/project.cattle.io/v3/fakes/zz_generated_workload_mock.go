...
// Ensure, that WorkloadListerMock does implement v3.WorkloadLister.
// If this is not the case, regenerate this file with moq.
var _ v3.WorkloadLister = &WorkloadListerMock{}

// WorkloadListerMock is a mock implementation of v3.WorkloadLister.
//
//     func TestSomethingThatUsesWorkloadLister(t *testing.T) {
//
//         // make and configure a mocked v3.WorkloadLister
...
//         }
//
//         // use mockedWorkloadLister in code that requires v3.WorkloadLister
...
// Ensure, that WorkloadControllerMock does implement v3.WorkloadController.
// If this is not the case, regenerate this file with moq.
var _ v3.WorkloadController = &WorkloadControllerMock{}

// WorkloadControllerMock is a mock implementation of v3.WorkloadController.
//
//     func TestSomethingThatUsesWorkloadController(t *testing.T) {
//
//         // make and configure a mocked v3.WorkloadController
...
//             },
//             AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.WorkloadHandlerFunc)  {
...
//         }
//
//         // use mockedWorkloadController in code that requires v3.WorkloadController
//         // and then make assertions.
//
//     }
...
func (mock *WorkloadControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.WorkloadHandlerFunc) {
...
// Ensure, that WorkloadInterfaceMock does implement v3.WorkloadInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.WorkloadInterface = &WorkloadInterfaceMock{}

// WorkloadInterfaceMock is a mock implementation of v3.WorkloadInterface.
//
//     func TestSomethingThatUsesWorkloadInterface(t *testing.T) {
//
//         // make and configure a mocked v3.WorkloadInterface
//         mockedWorkloadInterface := &WorkloadInterfaceMock{
//             AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.WorkloadHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
...
//             },
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, syncMoqParam v3.WorkloadHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
...
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, syncMoqParam v3.WorkloadHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
...
//         }
//
//         // use mockedWorkloadInterface in code that requires v3.WorkloadInterface
//         // and then make assertions.
//
//     }
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *WorkloadInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam v3.WorkloadHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *WorkloadInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, syncMoqParam v3.WorkloadHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *WorkloadInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam v3.WorkloadHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
// AddHandler calls AddHandlerFunc.
func (mock *WorkloadInterfaceMock) AddHandler(ctx context.Context, name string, syncMoqParam v3.WorkloadHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
// Ensure, that WorkloadsGetterMock does implement v3.WorkloadsGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.WorkloadsGetter = &WorkloadsGetterMock{}

// WorkloadsGetterMock is a mock implementation of v3.WorkloadsGetter.
//
//     func TestSomethingThatUsesWorkloadsGetter(t *testing.T) {
//
//         // make and configure a mocked v3.WorkloadsGetter
...
//         }
//
//         // use mockedWorkloadsGetter in code that requires v3.WorkloadsGetter
//         // and then make assertions.
//
//     }
