...
const (
	...
	// compatibility with previous norman lifecycle implementation, now split into separate OnChange + OnRemove handlers
...
func (n *nsLifecycle) onChange(_ string, obj *v1.Namespace) (*v1.Namespace, error) {
	obj, err := n.removeLegacyFinalizer(obj)
	if err != nil {
		return nil, err
	}
...
func (n *nsLifecycle) removeLegacyFinalizer(obj *v1.Namespace) (*v1.Namespace, error) {
	if obj == nil {
		return nil, nil
	}
...
func (n *nsLifecycle) onRemove(_ string, obj *v1.Namespace) (*v1.Namespace, error) {
