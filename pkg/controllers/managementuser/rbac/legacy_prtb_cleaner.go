...
func (p *crbCleaner) sync(key string, obj *rbacv1.ClusterRoleBinding) (*rbacv1.ClusterRoleBinding, error) {
	if key == "" || obj == nil {
		return nil, nil
	}
	...
	if eligible {
		if err := p.m.workload.RBACw.ClusterRoleBinding().Delete(obj.Name, &metav1.DeleteOptions{}); err != nil {
