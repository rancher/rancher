...
func TestCRBSyncChecksGlobalAdminRole(t *testing.T) {
	...
	t.Run("user admin", func(t *testing.T) {
		obj, err := crbCleaner.sync("globaladmin-u-hgk79", &rbacv1.ClusterRoleBinding{
			ObjectMeta: metav1.ObjectMeta{
		...
		require.IsType(t, &rbacv1.ClusterRoleBinding{}, obj)
	...
	t.Run("group admin", func(t *testing.T) {
		obj, err := crbCleaner.sync("globaladmin-u-qbkn4w4tqr", &rbacv1.ClusterRoleBinding{
			ObjectMeta: metav1.ObjectMeta{
	...
	t.Run("orphaned CRB", func(t *testing.T) {
		obj, err := crbCleaner.sync("globaladmin-u-8ztgw", &rbacv1.ClusterRoleBinding{
			ObjectMeta: metav1.ObjectMeta{
