...
// with the default values set in the global settings. If the cluster-agent-scheduling-customization feature is
// disabled, the cluster will be returned unchanged. The provisioning.cattle.io/enable-scheduling-customization
...
// with the default values set in the global settings. If the cluster-agent-scheduling-customization feature is
// disabled, the cluster will be returned unchanged. The provisioning.cattle.io/enable-fleet-scheduling-customization
// annotation can be set to 'true' or 'false', which will add or remove the scheduling customization field as needed.
...
// annotation on the v3.Cluster and if found populates the spec.FleetAgentDeploymentCustomization.SchedulingCustomization fields
// with the default values set in the global settings. If the cluster-agent-scheduling-customization feature is
// disabled, the cluster will be returned unchanged. The provisioning.cattle.io/enable-fleet-scheduling-customization
// annotation can be set to 'true' or 'false', which will add or remove the scheduling customization field as needed.
