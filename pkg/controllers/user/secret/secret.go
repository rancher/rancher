	...
	if obj.Annotations[projectIDLabel] != "" {
		...
		if len(parts) == 2 {
			...
			for _, secret := range secrets {
				// shouldn't copy default-token-xxx secret because this is generated by kubernetes tokens_controller
				// https://github.com/kubernetes/kubernetes/blob/master/pkg/controller/serviceaccount/tokens_controller.go#L385
