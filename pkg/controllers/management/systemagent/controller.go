...
func SystemAgentUpgraderVersion()
string{
...
func installer(cluster *apimgmtv3.Cluster, secretName
...
func winsUpgradePlan(cluster *apimgmtv3.Cluster, env[]
corev1.EnvVar, secretName
string) *upgradev1.Plan{
