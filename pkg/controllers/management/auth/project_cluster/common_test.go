...
func TestCheckPSAMembershipRole(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "not create psa role / no prtbs available",
			obj: &apisv3.Project{
				TypeMeta: metav1.TypeMeta{
					APIVersion: "v3",
					Kind:       "Project",
		...
		{
			name: "doesn't create psa role - no rt available",
			obj: &apisv3.Project{
				TypeMeta: metav1.TypeMeta{
					APIVersion: "v3",
					Kind:       "Project",
		...
		{
			name: "doesn't create psa role - no updatepsa verb in rt",
			obj: &apisv3.Project{
				TypeMeta: metav1.TypeMeta{
					APIVersion: "v3",
					Kind:       "Project",
