...
func (l *Lifecycle) createOrUpdateDynamicSchema(obj *v3.KontainerDriver) error {
	...
	if obj.Spec.BuiltIn {
		// Delete the dynamicSchema for builtins since AKS, GKE and EKS provisioning no longer use KontainerEngine or dynamicSchema
		// Ignore the error to not disturb anything else.
		_ = l.dynamicSchemas.Delete(dynamicSchema.Name, &v13.DeleteOptions{})
		return nil
	}
