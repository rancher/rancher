...
func (m *Lifecycle) userNodeRemoveCleanup(obj *v3.Node) (runtime.Object, error) {
	...
	newObj.SetAnnotations(removeAnnotationWithPrefix(newObj.GetAnnotations(), userNodeRemoveAnnotationPrefix))
	delete(newObj.Annotations, userNodeRemoveCleanupAnnotationOld)
	newObj.Annotations[userNodeRemoveCleanupAnnotation] = "true"
