	...
	obj, err := v3.ClusterConditionSecretsMigrated.Do(cluster, func() (runtime.Object, error) {
		...
		for _, p := range projects {
			...
			if !apierrors.IsNotFound(err) {
				...
				github := &pv3.GithubPipelineConfig{}
			...
			if !apierrors.IsNotFound(err) {
				...
				gitlab := &pv3.GitlabPipelineConfig{}
			...
			if !apierrors.IsNotFound(err) {
				...
				bbcloud := &pv3.BitbucketCloudPipelineConfig{}
			...
			if !apierrors.IsNotFound(err) {
				...
				bbserver := &pv3.BitbucketServerPipelineConfig{}
...
// the caller is responsible for un-setting the secret data, setting a reference to the Secret, and
// updating the Cluster object, if applicable.
func (m *Migrator) CreateOrUpdateVsphereGlobalSecret(secretName string, rkeConfig *v3.RancherKubernetesEngineConfig, owner runtime.Object) (*corev1.Secret, error) {
...
// the caller is responsible for un-setting the secret data, setting a reference to the Secret, and
// updating the Cluster object, if applicable.
func (m *Migrator) CreateOrUpdateVsphereVirtualCenterSecret(secretName string, rkeConfig *v3.RancherKubernetesEngineConfig, owner runtime.Object) (*corev1.Secret, error) {
	if rkeConfig == nil || rkeConfig.CloudProvider.VsphereCloudProvider == nil {
		return nil, nil
	}
	data := map[string]string{}
...
// the caller is responsible for un-setting the secret data, setting a reference to the Secret, and
// updating the Cluster object, if applicable.
func (m *Migrator) CreateOrUpdateOpenStackSecret(secretName string, rkeConfig *v3.RancherKubernetesEngineConfig, owner runtime.Object) (*corev1.Secret, error) {
...
// the caller is responsible for un-setting the secret data, setting a reference to the Secret, and
// updating the Cluster object, if applicable.
func (m *Migrator) CreateOrUpdateAADClientSecret(secretName string, rkeConfig *v3.RancherKubernetesEngineConfig, owner runtime.Object) (*corev1.Secret, error) {
...
// the caller is responsible for un-setting the secret data, setting a reference to the Secret, and
// updating the Cluster object, if applicable.
func (m *Migrator) CreateOrUpdateAADCertSecret(secretName string, rkeConfig *v3.RancherKubernetesEngineConfig, owner runtime.Object) (*corev1.Secret, error) {
	if rkeConfig == nil || rkeConfig.CloudProvider.AzureCloudProvider == nil {
		return nil, nil
	}
...
// the caller is responsible for un-setting the secret data, setting a reference to the Secret, and
// updating the Cluster object, if applicable.
func (m *Migrator) CreateOrUpdateSMTPSecret(secretName string, smtpConfig *v3.SMTPConfig, owner runtime.Object) (*corev1.Secret, error) {
	if smtpConfig == nil {
		return nil, nil
	}
...
// the caller is responsible for un-setting the secret data, setting a reference to the Secret, and
// updating the Cluster object, if applicable.
func (m *Migrator) CreateOrUpdateWechatSecret(secretName string, wechatConfig *v3.WechatConfig, owner runtime.Object) (*corev1.Secret, error) {
	if wechatConfig == nil {
		return nil, nil
	}
...
// the caller is responsible for un-setting the secret data, setting a reference to the Secret, and
// updating the Cluster object, if applicable.
func (m *Migrator) CreateOrUpdateDingtalkSecret(secretName string, dingtalkConfig *v3.DingtalkConfig, owner runtime.Object) (*corev1.Secret, error) {
