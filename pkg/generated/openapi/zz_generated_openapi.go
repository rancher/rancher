		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"ttl": {
						SchemaProps: spec.SchemaProps{
							Description: "TTL is the time-to-live of the token, in milliseconds. Setting a value < 0 represents +infinity, i.e. a token which does not expire. The default is indicated by the value `0`. This default is provided by the `auth-token-default-ttl-minutes` setting. A value <= 0 there enables non-expiring tokens.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
