		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"PrincipalID": {
						SchemaProps: spec.SchemaProps{
							Description: "PrincipalID is retrieved from the UserAttribute resource referenced by `Spec.UserID`. It is the first principal id found for the auth provider. Stored as it is one of the pieces required to to internally assemble a v3.Principal structure for the token.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"expired", "expiresAt", "authProvider", "DisplayName", "LoginName", "PrincipalID", "lastUpdateTime"},
			},
		},
		Dependencies: []string{
