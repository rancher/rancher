...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/rancher/rancher/pkg/apis/scc.cattle.io/v1.SystemRegistrationState": schema_pkg_apis_scccattleio_v1_SystemRegistrationState(ref),
...
func schema_pkg_apis_scccattleio_v1_RegistrationStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"registrationStatus": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/rancher/rancher/pkg/apis/scc.cattle.io/v1.SystemRegistrationState"),
						},
					},
					"activationStatus": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/rancher/rancher/pkg/apis/scc.cattle.io/v1.SystemActivationState", "github.com/rancher/rancher/pkg/apis/scc.cattle.io/v1.SystemRegistrationState", "github.com/rancher/wrangler/v3/pkg/genericcondition.GenericCondition", "k8s.io/api/core/v1.SecretReference"},
	}
}
...
func schema_pkg_apis_scccattleio_v1_SystemRegistrationState(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
