...
func FromClusterHandlerToHandler(sync ClusterHandler) generic.Handler {
	return func(key string, obj runtime.Object) (ret runtime.Object, err error) {
		var v *v1alpha4.Cluster
		if obj == nil {
			v, err = sync(key, nil)
		} else {
			v, err = sync(key, obj.(*v1alpha4.Cluster))
		}
		if v == nil {
			return nil, err
		}
...
func (c *clusterController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1alpha4.Cluster))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func (c *clusterController) Create(obj *v1alpha4.Cluster) (*v1alpha4.Cluster, error) {
	result := &v1alpha4.Cluster{}
	return result, c.client.Create(context.TODO(), obj.Namespace, obj, result, metav1.CreateOptions{})
}

func (c *clusterController) Update(obj *v1alpha4.Cluster) (*v1alpha4.Cluster, error) {
	result := &v1alpha4.Cluster{}
	return result, c.client.Update(context.TODO(), obj.Namespace, obj, result, metav1.UpdateOptions{})
}

func (c *clusterController) UpdateStatus(obj *v1alpha4.Cluster) (*v1alpha4.Cluster, error) {
	result := &v1alpha4.Cluster{}
...
func (c *clusterController) Get(namespace, name string, options metav1.GetOptions) (*v1alpha4.Cluster, error) {
	result := &v1alpha4.Cluster{}
	return result, c.client.Get(context.TODO(), namespace, name, result, options)
}

func (c *clusterController) List(namespace string, opts metav1.ListOptions) (*v1alpha4.ClusterList, error) {
...
func (c *clusterController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v1alpha4.Cluster, error) {
	result := &v1alpha4.Cluster{}
...
func (c *clusterCache) Get(namespace, name string) (*v1alpha4.Cluster, error) {
...
func (c *clusterCache) List(namespace string, selector labels.Selector) (ret []*v1alpha4.Cluster, err error) {
...
func (c *clusterCache) AddIndexer(indexName string, indexer ClusterIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1alpha4.Cluster))
		},
	}))
}

func (c *clusterCache) GetByIndex(indexName, key string) (result []*v1alpha4.Cluster, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v1alpha4.Cluster, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v1alpha4.Cluster))
	}
	return result, nil
}
...
func (a *clusterStatusHandler) sync(key string, obj *v1alpha4.Cluster) (*v1alpha4.Cluster, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *clusterGeneratingHandler) Remove(key string, obj *v1alpha4.Cluster) (*v1alpha4.Cluster, error) {
	if obj != nil {
		return obj, nil
	}
