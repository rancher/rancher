...
type NodeStatusHandler func(ctx context.Context, obj *v3.Node, status v3.NodeStatus) (v3.NodeStatus, error)
...
type NodeGeneratingHandler func(ctx context.Context, obj *v3.Node, status v3.NodeStatus) ([]runtime.Object, v3.NodeStatus, error)
...
func (a *nodeStatusHandler) sync(ctx context.Context, key string, obj *v3.Node) (*v3.Node, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *nodeGeneratingHandler) Remove(ctx context.Context, key string, obj *v3.Node) (*v3.Node, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *nodeGeneratingHandler) Handle(ctx context.Context, obj *v3.Node, status v3.NodeStatus) (v3.NodeStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.NodeGeneratingHandler(ctx, obj, status)
	if err != nil {
