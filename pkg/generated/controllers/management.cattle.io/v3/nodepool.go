...
type NodePoolStatusHandler func(ctx context.Context, obj *v3.NodePool, status v3.NodePoolStatus) (v3.NodePoolStatus, error)
...
type NodePoolGeneratingHandler func(ctx context.Context, obj *v3.NodePool, status v3.NodePoolStatus) ([]runtime.Object, v3.NodePoolStatus, error)
...
func (a *nodePoolStatusHandler) sync(ctx context.Context, key string, obj *v3.NodePool) (*v3.NodePool, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *nodePoolGeneratingHandler) Remove(ctx context.Context, key string, obj *v3.NodePool) (*v3.NodePool, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *nodePoolGeneratingHandler) Handle(ctx context.Context, obj *v3.NodePool, status v3.NodePoolStatus) (v3.NodePoolStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.NodePoolGeneratingHandler(ctx, obj, status)
	if err != nil {
