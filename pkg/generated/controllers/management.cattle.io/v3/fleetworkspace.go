...
type FleetWorkspaceStatusHandler func(ctx context.Context, obj *v3.FleetWorkspace, status v3.FleetWorkspaceStatus) (v3.FleetWorkspaceStatus, error)
...
type FleetWorkspaceGeneratingHandler func(ctx context.Context, obj *v3.FleetWorkspace, status v3.FleetWorkspaceStatus) ([]runtime.Object, v3.FleetWorkspaceStatus, error)
...
func (a *fleetWorkspaceStatusHandler) sync(ctx context.Context, key string, obj *v3.FleetWorkspace) (*v3.FleetWorkspace, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *fleetWorkspaceGeneratingHandler) Remove(ctx context.Context, key string, obj *v3.FleetWorkspace) (*v3.FleetWorkspace, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *fleetWorkspaceGeneratingHandler) Handle(ctx context.Context, obj *v3.FleetWorkspace, status v3.FleetWorkspaceStatus) (v3.FleetWorkspaceStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.FleetWorkspaceGeneratingHandler(ctx, obj, status)
	if err != nil {
