...
// ProjectHandler is function for performing any potential modifications to a Project resource.
type ProjectHandler func(string, *v3.Project) (*v3.Project, error)

// ProjectIndexer computes a set of indexed values for the provided object.
type ProjectIndexer func(obj *v3.Project) ([]string, error)

// ProjectGenericController wraps wrangler/pkg/generic.Controller so that the function definitions adhere to ProjectController interface.
...
// ProjectGenericCache wraps wrangler/pkg/generic.Cache so the function definitions adhere to ProjectCache interface.
