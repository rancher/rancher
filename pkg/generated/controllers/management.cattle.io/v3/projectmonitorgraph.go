...
// ProjectMonitorGraphHandler is function for performing any potential modifications to a ProjectMonitorGraph resource.
type ProjectMonitorGraphHandler func(string, *v3.ProjectMonitorGraph) (*v3.ProjectMonitorGraph, error)

// ProjectMonitorGraphIndexer computes a set of indexed values for the provided object.
type ProjectMonitorGraphIndexer func(obj *v3.ProjectMonitorGraph) ([]string, error)

// ProjectMonitorGraphGenericController wraps wrangler/pkg/generic.Controller so that the function definitions adhere to ProjectMonitorGraphController interface.
...
// ProjectMonitorGraphGenericCache wraps wrangler/pkg/generic.Cache so the function definitions adhere to ProjectMonitorGraphCache interface.
