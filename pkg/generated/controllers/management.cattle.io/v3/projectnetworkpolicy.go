...
// ProjectNetworkPolicyHandler is function for performing any potential modifications to a ProjectNetworkPolicy resource.
type ProjectNetworkPolicyHandler func(string, *v3.ProjectNetworkPolicy) (*v3.ProjectNetworkPolicy, error)

// ProjectNetworkPolicyIndexer computes a set of indexed values for the provided object.
type ProjectNetworkPolicyIndexer func(obj *v3.ProjectNetworkPolicy) ([]string, error)

// ProjectNetworkPolicyGenericController wraps wrangler/pkg/generic.Controller so that the function definitions adhere to ProjectNetworkPolicyController interface.
...
// ProjectNetworkPolicyGenericCache wraps wrangler/pkg/generic.Cache so the function definitions adhere to ProjectNetworkPolicyCache interface.
