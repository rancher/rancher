...
// DeleteCollection provides a mock function with given fields: namespace, deleteOpts, listOpts
func (_m *PodClient) DeleteCollection(namespace string, deleteOpts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	ret := _m.Called(namespace, deleteOpts, listOpts)
	...
	if rf, ok := ret.Get(0).(func(string, metav1.DeleteOptions, metav1.ListOptions) error); ok {
		r0 = rf(namespace, deleteOpts, listOpts)
	} else {
		r0 = ret.Error(0)
	}
