...
func fromHelm4ReleaseToRelease(release *release.Release, isNamespaced IsNamespaced) (*v1.ReleaseSpec, error) {
	var (
		info  = &v1.Info{}
		chart = &v1.Chart{}
		err   error
...
func decodeHelm4(data string) (*release.Release, error) {
