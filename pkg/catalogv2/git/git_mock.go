...
func (m *Mockrepository) fetchAndReset(commit plumbing.Hash, branch string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "fetchAndReset", commit, branch)
	ret0, _ := ret[0].(error)
	return ret0
}

// fetchAndReset indicates an expected call of fetchAndReset.
func (mr *MockrepositoryMockRecorder) fetchAndReset(commit, branch interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "fetchAndReset", reflect.TypeOf((*Mockrepository)(nil).fetchAndReset), commit, branch)
}
...
func (m *Mockrepository) hardReset(reference plumbing.Hash) error {
	m.ctrl.T.Helper()
