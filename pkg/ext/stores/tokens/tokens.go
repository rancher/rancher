...
func (t *Store) Create(
	...
	logrus.Infof("ext.cattle.io/token create")
...
func (t *Store) Delete(
	...
	logrus.Infof("ext.cattle.io/token delete [%s]", name)
...
func (t *Store) Get(
	...
	logrus.Infof("ext.cattle.io/token get [%s]", name)
...
func (t *Store) List(
	...
	logrus.Infof("ext.cattle.io/token list")
...
func (t *Store) Update(
	...
	logrus.Infof("ext.cattle.io/token update [%s]", name)
...
func (t *Store) Watch(
	...
	logrus.Infof("ext.cattle.io/token watch")
...
func (t *Store) create(ctx context.Context, token *ext.Token, options *metav1.CreateOptions) (*ext.Token, error) {
	logrus.Infof("ext.cattle.io/token /create [%s]", token.Name)
...
func (t *SystemStore) Create(ctx context.Context, group schema.GroupResource, token *ext.Token, options *metav1.CreateOptions) (*ext.Token, error) {
	logrus.Infof("ext.cattle.io/token sys.create [%s]", token.Name)
...
func (t *Store) delete(ctx context.Context, token *ext.Token, options *metav1.DeleteOptions) error {
	logrus.Infof("ext.cattle.io/token /delete [%s]", token.Name)
...
func (t *SystemStore) Delete(name string, options *metav1.DeleteOptions) error {
	logrus.Infof("ext.cattle.io/token sys.delete [%s]", name)
...
func (t *SystemStore) Get(name, sessionID string, options *metav1.GetOptions) (*ext.Token, error) {
	logrus.Infof("ext.cattle.io/token sys.get [%s] (%s)", name, sessionID)
...
func (t *SystemStore) ListForUser(userName string) (*ext.TokenList, error) {
	logrus.Infof("ext.cattle.io/token sys.list-for-user [%s]", userName)
...
func (t *SystemStore) list(isAdmin bool, userName, sessionID string, options *metav1.ListOptions) (*ext.TokenList, error) {
	logrus.Infof("ext.cattle.io/token sys.list admin=%v [%s]", isAdmin, sessionID)
	...
	if localOptions == empty {
		...
		logrus.Infof("ext.cattle.io/token sys.list admin=%v [%s] quick empty", isAdmin, sessionID)
	...
	logrus.Infof("ext.cattle.io/token sys.list admin=%v [%s] reporting %d", isAdmin, sessionID, len(tokens))
	return &ext.TokenList{
...
func (t *Store) update(ctx context.Context, token *ext.Token, options *metav1.UpdateOptions) (*ext.Token, error) {
	logrus.Infof("ext.cattle.io/token /update [%s]", token.Name)
...
func (t *SystemStore) update(sessionID string, fullPermission bool, token *ext.Token,
	...
	logrus.Infof("ext.cattle.io/token sys.update [%s] full=%v", sessionID, fullPermission)
...
func (t *SystemStore) UpdateLastUsedAt(name string, now time.Time) error {
	logrus.Infof("ext.cattle.io/token sys.update-last-used-at [%s]", name)
...
func (t *SystemStore) UpdateLastActivitySeen(name string, now time.Time) error {
	logrus.Infof("ext.cattle.io/token sys.update-last-activity-seen [%s]", name)
...
func (t *SystemStore) Disable(name string) error {
	logrus.Infof("ext.cattle.io/token sys.disable [%s]", name)
...
func (tp *tokenAuth) UserName(ctx context.Context, store *SystemStore) (string, bool, bool, error) {
	...
	if !strings.Contains(userName, ":") { // E.g. system:admin
		...
		logrus.Infof("ext.cattle.io/token username: %s, check in rancher", userName)
	...
	logrus.Infof("ext.cattle.io/token username: %s admin=%v rancher=%v", userName, isAdmin, isRancherUser)
