...
func (t *TokenStore) Create(ctx extcore.Context, token *ext.Token, opts *metav1.CreateOptions) (*ext.Token, error) {
	...
	return t.SystemTokenStore.Create(ctx.GroupVersionResource.GroupResource(), token, opts)
}

func (t *SystemTokenStore) Create(group schema.GroupResource, token *ext.Token, opts *metav1.CreateOptions) (*ext.Token, error) {
