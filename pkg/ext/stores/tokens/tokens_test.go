...
func Test_Store_Delete(t *testing.T) {
	...
	t.Run("user info missing from context", func(t *testing.T) {
		...
		store := New(nil, secrets, nil, nil, nil, nil, auth)
...
func Test_Store_Update(t *testing.T) {
	...
	t.Run("owned", func(t *testing.T) {
		...
		auth := NewMockauthHandler(ctrl)
		store := New(nil, secrets, nil, nil, timer, nil, auth)
...
func Test_Store_Create(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			auth := NewMockauthHandler(ctrl)
			store := New(space, secrets, uattrs, users, timer, hasher, auth)
			test.storeSetup(space, secrets, uattrs, users, timer, hasher, auth)
