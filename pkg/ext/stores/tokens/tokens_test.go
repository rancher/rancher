...
func Test_Store_Delete(t *testing.T) {
	...
	t.Run("permission error", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		secrets := fake.NewMockControllerInterface[*corev1.Secret, *corev1.SecretList](ctrl)
		checker := NewMockpermissionHandler(ctrl)
		...
		checker.EXPECT().UserHasPermission("delete", gomock.Any(), gomock.Any()).
...
func Test_Store_List(t *testing.T) {
	// The majority of the code is tested later, in Test_SystemStore_List
	// Here we only test the permission checks done before delegation to the
	// embedded system store
	t.Run("permission error", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		checker := NewMockpermissionHandler(ctrl)
		store := New(nil, nil, nil, nil, nil, nil, checker)

		checker.EXPECT().UserHasManageTokenPermissions(gomock.Any()).
			Return(false, someerror)
...
func Test_Store_Get(t *testing.T) {
	...
	t.Run("permission error", func(t *testing.T) {
		...
		checker.EXPECT().UserHasPermission("get", gomock.Any(), gomock.Any()).
			Return(false, someerror)
...
func Test_Store_Update(t *testing.T) {
	...
	t.Run("permission error after user mismatch", func(t *testing.T) {
		...
		checker.EXPECT().UserHasPermission("update", gomock.Any(), gomock.Any()).
			Return(false, someerror)
	...
	t.Run("user match", func(t *testing.T) {
		...
		secrets := fake.NewMockControllerInterface[*corev1.Secret, *corev1.SecretList](ctrl)
		timer := NewMocktimeHandler(ctrl)
		store := New(nil, secrets, nil, nil, timer, nil, nil)
	...
	tests := []struct {
	...
	}{
		{
			...
			storeSetup: func( // configure store backend clients
				...
				checker.EXPECT().UserHasPermission("create", gomock.Any(), gomock.Any()).
					Return(false, someerror)
			},
		},
		{
