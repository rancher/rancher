...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/rancher/rancher/pkg/ext/resources/useractivity.UserActivity":       schema_pkg_ext_resources_useractivity_UserActivity(ref),
		"github.com/rancher/rancher/pkg/ext/resources/useractivity.UserActivityList":   schema_pkg_ext_resources_useractivity_UserActivityList(ref),
		"github.com/rancher/rancher/pkg/ext/resources/useractivity.UserActivitySpec":   schema_pkg_ext_resources_useractivity_UserActivitySpec(ref),
		"github.com/rancher/rancher/pkg/ext/resources/useractivity.UserActivityStatus": schema_pkg_ext_resources_useractivity_UserActivityStatus(ref),
...
func schema_pkg_ext_resources_useractivity_UserActivity(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/rancher/rancher/pkg/ext/resources/useractivity.UserActivitySpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/rancher/rancher/pkg/ext/resources/useractivity.UserActivityStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/rancher/rancher/pkg/ext/resources/useractivity.UserActivitySpec", "github.com/rancher/rancher/pkg/ext/resources/useractivity.UserActivityStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_ext_resources_useractivity_UserActivityList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/rancher/rancher/pkg/ext/resources/useractivity.UserActivity"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/rancher/rancher/pkg/ext/resources/useractivity.UserActivity", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_ext_resources_useractivity_UserActivitySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_ext_resources_useractivity_UserActivityStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
