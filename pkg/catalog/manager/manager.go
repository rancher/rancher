...
type CatalogManager interface {
	...
	LatestAvailableTemplateVersion(template *v3.CatalogTemplate, clusterName string) (*v3.TemplateVersionSpec, error)
	GetSystemAppCatalogID(templateVersionID, clusterName string) (string, error)
}

func New(management v3.Interface, project projectv3.Interface) *Manager {
...
func (m *Manager) LatestAvailableTemplateVersion(template *v3.CatalogTemplate, clusterName string) (*v3.TemplateVersionSpec, error) {
