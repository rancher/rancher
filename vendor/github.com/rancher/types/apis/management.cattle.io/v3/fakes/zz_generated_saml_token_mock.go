...
// Ensure, that SamlTokenListerMock does implement SamlTokenLister.
// If this is not the case, regenerate this file with moq.
var _ v3.SamlTokenLister = &SamlTokenListerMock{}

// SamlTokenListerMock is a mock implementation of SamlTokenLister.
//
//     func TestSomethingThatUsesSamlTokenLister(t *testing.T) {
//
//         // make and configure a mocked SamlTokenLister
...
//         }
//
//         // use mockedSamlTokenLister in code that requires SamlTokenLister
...
var (
	...
	lockSamlTokenControllerMockStart                          sync.RWMutex
	lockSamlTokenControllerMockSync                           sync.RWMutex
)

// Ensure, that SamlTokenControllerMock does implement SamlTokenController.
// If this is not the case, regenerate this file with moq.
var _ v3.SamlTokenController = &SamlTokenControllerMock{}

// SamlTokenControllerMock is a mock implementation of SamlTokenController.
//
//     func TestSomethingThatUsesSamlTokenController(t *testing.T) {
//
//         // make and configure a mocked SamlTokenController
//         mockedSamlTokenController := &SamlTokenControllerMock{
//             AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, handler v3.SamlTokenHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler v3.SamlTokenHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, sync v3.SamlTokenHandlerFunc)  {
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler v3.SamlTokenHandlerFunc)  {
...
//             },
//             ListerFunc: func() v3.SamlTokenLister {
...
//         }
//
//         // use mockedSamlTokenController in code that requires SamlTokenController
//         // and then make assertions.
//
//     }
type SamlTokenControllerMock struct {
	...
	calls struct {
		...
		AddClusterScopedFeatureHandler []struct {
			...
			Handler v3.SamlTokenHandlerFunc
		}
...
func (mock *SamlTokenControllerMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, handler v3.SamlTokenHandlerFunc) {
...
func (mock *SamlTokenControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, sync v3.SamlTokenHandlerFunc) {
...
func (mock *SamlTokenControllerMock) AddHandler(ctx context.Context, name string, handler v3.SamlTokenHandlerFunc) {
...
func (mock *SamlTokenControllerMock) Lister() v3.SamlTokenLister {
...
func (mock *SamlTokenControllerMock) Start(ctx context.Context, threadiness int) error {
	if mock.StartFunc == nil {
		panic("SamlTokenControllerMock.StartFunc: method is nil but SamlTokenController.Start was just called")
	}
	callInfo := struct {
		Ctx         context.Context
		Threadiness int
	...
	lockSamlTokenControllerMockStart.Lock()
	mock.calls.Start = append(mock.calls.Start, callInfo)
	lockSamlTokenControllerMockStart.Unlock()
	return mock.StartFunc(ctx, threadiness)
}

// StartCalls gets all the calls that were made to Start.
// Check the length with:
//     len(mockedSamlTokenController.StartCalls())
func (mock *SamlTokenControllerMock) StartCalls() []struct {
	Ctx         context.Context
	Threadiness int
} {
	var calls []struct {
	...
	lockSamlTokenControllerMockStart.RLock()
	calls = mock.calls.Start
	lockSamlTokenControllerMockStart.RUnlock()
	return calls
}

// Sync calls SyncFunc.
func (mock *SamlTokenControllerMock) Sync(ctx context.Context) error {
	if mock.SyncFunc == nil {
		panic("SamlTokenControllerMock.SyncFunc: method is nil but SamlTokenController.Sync was just called")
	}
	callInfo := struct {
		Ctx context.Context
	}{
	...
	lockSamlTokenControllerMockSync.Lock()
	mock.calls.Sync = append(mock.calls.Sync, callInfo)
	lockSamlTokenControllerMockSync.Unlock()
	return mock.SyncFunc(ctx)
}

// SyncCalls gets all the calls that were made to Sync.
// Check the length with:
//     len(mockedSamlTokenController.SyncCalls())
func (mock *SamlTokenControllerMock) SyncCalls() []struct {
	Ctx context.Context
} {
	var calls []struct {
		Ctx context.Context
	}
	lockSamlTokenControllerMockSync.RLock()
	calls = mock.calls.Sync
	lockSamlTokenControllerMockSync.RUnlock()
	return calls
}
...
// Ensure, that SamlTokenInterfaceMock does implement SamlTokenInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.SamlTokenInterface = &SamlTokenInterfaceMock{}

// SamlTokenInterfaceMock is a mock implementation of SamlTokenInterface.
//
//     func TestSomethingThatUsesSamlTokenInterface(t *testing.T) {
//
//         // make and configure a mocked SamlTokenInterface
//         mockedSamlTokenInterface := &SamlTokenInterfaceMock{
//             AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, sync v3.SamlTokenHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, lifecycle v3.SamlTokenLifecycle)  {
// 	               panic("mock out the AddClusterScopedFeatureLifecycle method")
//             },
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync v3.SamlTokenHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle v3.SamlTokenLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, sync v3.SamlTokenHandlerFunc)  {
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(ctx context.Context, enabled func() bool, name string, lifecycle v3.SamlTokenLifecycle)  {
// 	               panic("mock out the AddFeatureLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync v3.SamlTokenHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle v3.SamlTokenLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() v3.SamlTokenController {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*v3.SamlToken, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*v3.SamlToken, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*v3.SamlTokenList, error) {
// 	               panic("mock out the List method")
//             },
//             ListNamespacedFunc: func(namespace string, opts v1.ListOptions) (*v3.SamlTokenList, error) {
...
//         }
//
//         // use mockedSamlTokenInterface in code that requires SamlTokenInterface
//         // and then make assertions.
//
//     }
type SamlTokenInterfaceMock struct {
	...
	calls struct {
		...
		AddClusterScopedFeatureLifecycle []struct {
			...
			Lifecycle v3.SamlTokenLifecycle
		}
		// AddClusterScopedHandler holds details about calls to the AddClusterScopedHandler method.
		AddClusterScopedHandler []struct {
			// Ctx is the ctx argument value.
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *SamlTokenInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, sync v3.SamlTokenHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *SamlTokenInterfaceMock) AddClusterScopedFeatureLifecycle(ctx context.Context, enabled func() bool, name string, clusterName string, lifecycle v3.SamlTokenLifecycle) {
...
func (mock *SamlTokenInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle v3.SamlTokenLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *SamlTokenInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, sync v3.SamlTokenHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *SamlTokenInterfaceMock) AddFeatureLifecycle(ctx context.Context, enabled func() bool, name string, lifecycle v3.SamlTokenLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *SamlTokenInterfaceMock) AddHandler(ctx context.Context, name string, sync v3.SamlTokenHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *SamlTokenInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle v3.SamlTokenLifecycle) {
...
func (mock *SamlTokenInterfaceMock) Controller() v3.SamlTokenController {
...
func (mock *SamlTokenInterfaceMock) Delete(name string, options *v1.DeleteOptions) error {
...
func (mock *SamlTokenInterfaceMock) DeleteCollection(deleteOpts *v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (mock *SamlTokenInterfaceMock) DeleteNamespaced(namespace string, name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *SamlTokenInterfaceMock) Get(name string, opts v1.GetOptions) (*v3.SamlToken, error) {
	if mock.GetFunc == nil {
...
func (mock *SamlTokenInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*v3.SamlToken, error) {
...
// List calls ListFunc.
func (mock *SamlTokenInterfaceMock) List(opts v1.ListOptions) (*v3.SamlTokenList, error) {
	if mock.ListFunc == nil {
...
func (mock *SamlTokenInterfaceMock) ListNamespaced(namespace string, opts v1.ListOptions) (*v3.SamlTokenList, error) {
...
func (mock *SamlTokenInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that SamlTokensGetterMock does implement SamlTokensGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.SamlTokensGetter = &SamlTokensGetterMock{}

// SamlTokensGetterMock is a mock implementation of SamlTokensGetter.
//
//     func TestSomethingThatUsesSamlTokensGetter(t *testing.T) {
//
//         // make and configure a mocked SamlTokensGetter
//         mockedSamlTokensGetter := &SamlTokensGetterMock{
//             SamlTokensFunc: func(namespace string) v3.SamlTokenInterface {
// 	               panic("mock out the SamlTokens method")
//             },
//         }
//
//         // use mockedSamlTokensGetter in code that requires SamlTokensGetter
//         // and then make assertions.
//
//     }
...
func (mock *SamlTokensGetterMock) SamlTokens(namespace string) v3.SamlTokenInterface {
