...
type LdapConfig struct {
	...
	GroupObjectClass                string   `json:"groupObjectClass,omitempty"            norman:"default=posixGroup,notnullable,required"`
	...
	GroupMemberMappingAttribute     string   `json:"groupMemberMappingAttribute,omitempty" norman:"default=memberUid,notnullable,required"`
