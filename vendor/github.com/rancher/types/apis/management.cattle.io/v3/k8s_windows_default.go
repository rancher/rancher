...
var (
	...
	AllK8sWindowsVersions = map[string]WindowsSystemImages{
		...
		"v1.14.1-rancher1-2": {
			...
			KubernetesBinaries: m("rancher/hyperkube:v1.14.1"),
			FlannelCNIBinaries: m("rancher/flannel-cni:v0.0.2"),
			KubeletPause:       m("rancher/kubelet-pause:v0.0.1"),
		},
	}

	// SupportWindowsServerVersion - build number map for windows
	// ref: https://www.microsoft.com/en-us/itpro/windows-10/release-information
	SupportWindowsServerVersion = map[string]string{
		"17763": "1809",
	}
)
