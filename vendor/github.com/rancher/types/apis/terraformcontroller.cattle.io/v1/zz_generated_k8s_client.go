...
type Client struct {
	...
	stateControllers  map[string]StateController
}
...
func (c *Client) States(namespace string) StateInterface {
	objectClient := objectclient.NewObjectClient(namespace, c.restClient, &StateResource, StateGroupVersionKind, stateFactory{})
	return &stateClient{
		ns:           namespace,
		client:       c,
		objectClient: objectClient,
