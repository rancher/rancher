...
const (
	...
	PodSecurityPolicyTemplateProjectBindingFieldPodSecurityPolicyTemplateID = "podSecurityPolicyTemplate"
	PodSecurityPolicyTemplateProjectBindingFieldProjectID                   = "projectId"
...
type PodSecurityPolicyTemplateProjectBinding struct {
	...
	PodSecurityPolicyTemplateID string            `json:"podSecurityPolicyTemplate,omitempty" yaml:"podSecurityPolicyTemplate,omitempty"`
